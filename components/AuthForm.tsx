                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        {type === 'sign-up' && (
                            <>
                              ...
                              <CustomInput 
                                control={form.control} name="address1" label="Address" placeholder="Enter your current address"
                              />

                              <CustomInput 
                                    control={form.control} name="city" label="City" placeholder="Enter your current city"
                                />
                              
                              <div className='flex gap-4'>
                                <CustomInput 
                                    control={form.control} name="province" label="Province" placeholder="e.g. Gauteng"
                                />
                                
                                <CustomInput 
                                    control={form.control} name="postalCode" label="Postal Code" placeholder="e.g. 1807"
                                />
                              </div>
                              <div className='flex gap-4'>
                                <CustomInput 
                                ...
                                <CustomInput 
                                    control={form.control} name="sarsTaxNumber" label="SARS Tax Number" placeholder="e.g. 1234"
                                />
                              </div>
                              <CustomInput 
                                control={form.control} name="cellphoneNumber" label="Cellphone Number" placeholder="e.g. 1234"
                              />
                            </>
                        )}
